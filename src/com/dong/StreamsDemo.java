...
public class StreamsDemo {
	...
	public static void main(String[] args) {
		...
		List<Product> products = new ArrayList<>(Arrays.asList(new Product("iPhone", 1099.99, 1345),
				new Product("Boots", 49.99, 15200), new Product("HP Laptop", 2599.99, 876),
				new Product("SSD", 239.99, 900), new Product("Sony PlayStation", 2009.99, 1001)));

		List<Product> modifiedProducts = products.stream().filter(product -> product.getItemsInWarehouse() > 1000)
				.map(product -> {
		...
		warehouse2
				.setProducts(Arrays.asList(new Product("Boots", 49.99, 15200), new Product("HP Laptop", 2599.99, 876)));
		warehouse3.setProducts(
				Arrays.asList(new Product("SSD", 239.99, 900), new Product("Sony PlayStation", 2009.99, 1001)));
